...
const SidebarConfig = ({
  ...
  return [
    ...
    //           path: PATH_DASHBOARD[ROLE_TAB.FACEBOOK][
    //             STATUS_ROLE_FACEBOOK.AD_FACEBOOK
    //           ],
    //           roles: isMatchRoles(
    //             user?.is_superuser,
    ...
    //           path: PATH_DASHBOARD[ROLE_TAB.FACEBOOK][
    //             STATUS_ROLE_FACEBOOK.AD_FANPAGE
    //           ],
    //           roles: isMatchRoles(
    //             user?.is_superuser,
    ...
    // },
    {
      ...
      items: [
        ...
        //     isMatchRoles(
        //       user?.is_superuser,
        //       roles?.[ROLE_TAB.LEAD]?.[PHONE_LEAD_PATH.VOIP]
        //     ),
        //   children: [
        //     {
        //       title: "Trạng thái",
        ...
        //     {
        //       title: "Spam check",
        //       path: PATH_DASHBOARD[ROLE_TAB.LEAD][PHONE_LEAD_PATH.SPAM_CHECK][
        //         ROOT
        //       ],
        //       roles: isMatchRoles(
        //         user?.is_superuser,
        ...
        //   roles: isMatchRoles(
        //     user?.is_superuser,
        //     roles?.[ROLE_TAB.SALE_ONLINE_REPORT]?.[
        ...
        //     user?.is_superuser,
        //     map(
        //       Object.values(STATUS_ROLE_ZALO),
        //       (item: string) => roles?.[ROLE_TAB.ZALO]?.[item]
        //     )
        //   ),
        //   children: [
        //     {
        ...
        //       path: PATH_DASHBOARD[ROLE_TAB.ZALO][
        //         STATUS_ROLE_ZALO.FOLLOWER_ACCOUNT
        //       ],
        //       roles: isMatchRoles(
        //         user?.is_superuser,
        ...
        //     {
        //       title: "Flow",
        //       path: PATH_DASHBOARD[ROLE_TAB.DATA_FLOW][
