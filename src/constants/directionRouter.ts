...
export const DIRECTION_ROUTE_OPTIONS: SelectOptionType[] = [
  {
    label: vi.dashboard,
    value: PATH_DASHBOARD[STATUS_ROLE_DASHBOARD.DASHBOARD],
  },
  {
    label: vi.dashboard_marketing,
    value: PATH_DASHBOARD[STATUS_ROLE_DASHBOARD.MKT_DASHBOARD],
  },
  {
    label: vi.dashboard_sale,
    value: PATH_DASHBOARD[STATUS_ROLE_DASHBOARD.SALE_DASHBOARD],
  },
